...
const VariadicFunction2<int, StringPiece*, const RE2&, RE2::Arg, RE2::FindAndConsumeN> RE2::FindAndConsume;
...
RE2::Options::Options(Encoding encoding, bool posix_syntax, bool longest_match, bool log_errors) :
	encoding_(encoding),
...
int RE2::FindAndConsumeN(StringPiece* input, const RE2& re,
                          const Arg* const args[], int n) {
  int consumed;
...
extern "C"
{
	...
	int64_t _strtoui64(const char *nptr, char **endptr, int base);
