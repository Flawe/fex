...
extern const int kDefaultMaxMem;
...
class RE2 {
 public:
  ...
  static int FindAndConsumeN(StringPiece* input, const RE2& pattern,
                             const Arg* const args[], int argc);
  static const VariadicFunction2<
      int, StringPiece*, const RE2&, Arg, RE2::FindAndConsumeN> FindAndConsume;
  ...
  class Options {
   ...
   private:
    ...
    friend class RE2;
    Options(Encoding encoding, bool posix_syntax, bool longest_match, bool log_errors);
